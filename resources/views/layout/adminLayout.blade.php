        ...
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="d-flex align-items-center ms-4 mb-4">
                <div class="position-relative">
                    <img class="rounded-circle me-lg-2" src="{{ asset('storage/' . user()->profile_picture) }}" alt="" style="width: 40px; height: 40px;">
            ...
            <div class="navbar-nav w-100">
                <li class="nav-item dropdown custom-dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu1 ">
                        <a class="dropdown-item text-center" href="{{ route('admin.contentManagement') }}">Artikel & Berita</a>
                        <a class="dropdown-item text-center" href="{{ route('admin.galeryManagement') }}">Galery</a>
                        <a class="dropdown-item text-center" href="{{ route('admin.eventManagement') }}">Event</a>
                    </div>
                </li>
            </div>
