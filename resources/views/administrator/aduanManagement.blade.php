...
<div class="container-fluid pt-4 px-4">
    <div class="col-10 tableContent g-4">
        <div class="bg-light rounded h-100 p-4">
            <h2 class="mb-4 text-center">Pengaturan Visi Aduan</h2>
            <div class="table-responsive">
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-success ms-2 addButton" onclick="tampilkanModal('store')">Tambah Visi aduan</button>
                </div>
                <table class="table align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary ButtonAksi" onclick="tampilkanModal( 'update', {{ $aduan->id }})"><p>Edit</p></button>
                                <form action="{{ route('misis.delete', ['id' => $aduan->id]) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this aduan?')">
                                    @csrf
                                    @method('delete')
