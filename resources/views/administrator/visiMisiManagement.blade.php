        ...
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="table-responsive">
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-success ms-2 addButton" onclick="tampilkanModal('store')">Tambah Visi Misi</button>
                </div>
                <table class="table align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><p>{{ $visi->visi }}</p></td>
                            <td>
                                <button class="btn btn-sm btn-primary ButtonAksi" onclick="tampilkanModal( 'update', {{ $visi->id }})"><p>Edit</p></button>
                ...
                <table class="table align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><p>{{ $misi->misi }}</p></td>
                            <td>
                                <button class="btn btn-sm btn-primary ButtonAksi" onclick="tampilkanModal( 'update', {{ $misi->id }})"><p>Edit</p></button>
