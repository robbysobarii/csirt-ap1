        ...
        <div class="bg-light rounded h-100 p-4">
            ...
            <div class="table-responsive">
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-success ms-2 addButton" onclick="tampilkanModal('store')">Tambah Visi va</button>
                </div>
                <table class="table align-middle text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary ButtonAksi" onclick="tampilkanModal( 'update', {{ $va->id }})"><p>Edit</p></button>
                                <form action="{{ route('misis.delete', ['id' => $va->id]) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this va?')">
                                    @csrf
                                    @method('delete')
