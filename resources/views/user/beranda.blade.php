...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateGallery() {
        ...
        for (let i = 0; i < visibleGalleryItems; i++) {
            const index = (galleryIndex + i) % totalGalleryItems;
            galleryItems[index].style.display = 'block';
        }
    }

    function showNextGallery() {
        galleryIndex = (galleryIndex + visibleGalleryItems) % totalGalleryItems;
        updateGallery();
    }

    function showPrevGallery() {
        galleryIndex = (galleryIndex - visibleGalleryItems + totalGalleryItems) % totalGalleryItems;
        updateGallery();
    }
